"""Tray host and icon helpers for the Linux desktop shell."""
...
from desktop.runtime.storage import (
    APP_ICON_PNG_FILE,
    TRAY_ACTIVE_PNG_FILE,
    TRAY_ERROR_PNG_FILE,
    TRAY_INACTIVE_PNG_FILE,
)
from desktop.shell.linux.ui import SettingsWindow
...
class TrayApp:
    ...
    def _get_tray_image(self):
        ...
        icon_map = {
            "connected": TRAY_ACTIVE_PNG_FILE,
            "connecting": APP_ICON_PNG_FILE,
            "disconnected": TRAY_INACTIVE_PNG_FILE,
            "error": TRAY_ERROR_PNG_FILE,
        }
        image = load_icon_image(icon_map.get(self.current_status, APP_ICON_PNG_FILE))
    ...
    def run(self):
        ...
        ico = load_icon_image(APP_ICON_PNG_FILE) or create_tray_icon((150, 150, 150, 255))

        self.icon = pystray.Icon(APP_NAME, ico, APP_NAME, menu)
